...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF699BF7);
  late Color secondary = const Color(0xFFF8F8F8);
  late Color tertiary = const Color(0xFFFF9A62);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F5F5);
  late Color accent1 = const Color(0xFFFAD656);
  late Color accent2 = const Color(0xFF29B160);
  late Color accent3 = const Color(0xFFFFA9A6);
  ...
  late Color light = Color(0xFFF8F8F8);
  late Color lineColor = Color(0xFFBBBBBB);
