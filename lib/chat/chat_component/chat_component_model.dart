...
import '/chat/thread/thread_widget.dart';
...
class ChatComponentModel extends FlutterFlowModel<ChatComponentWidget> {
  ...
  // Models for thread dynamic component.
  late FlutterFlowDynamicModels<ThreadModel> threadModels;
  ...
  void initState(BuildContext context) {
    threadModels = FlutterFlowDynamicModels(() => ThreadModel());
  }

  @override
  void dispose() {
    threadModels.dispose();
