...
import 'input_visit_model.dart';
export 'input_visit_model.dart';

class InputVisitWidget extends StatefulWidget {
  const InputVisitWidget({
    super.key,
  ...
  @override
  State<InputVisitWidget> createState() => _InputVisitWidgetState();
}

class _InputVisitWidgetState extends State<InputVisitWidget> {
  late InputVisitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputVisitModel());
    ...
    _model.inputrelationTextController ??= TextEditingController();
    _model.inputrelationFocusNode ??= FocusNode();
            ...
            children: [
              Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 22.0, 0.0, 14.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        FaIcon(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FlutterFlowChoiceChips(
                          options: [ChipData('Female'), ChipData('Male')],
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.inputrelationTextController,
                      focusNode: _model.inputrelationFocusNode,
                      autofocus: true,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelStyle:
                      ...
                      maxLines: null,
                      validator: _model.inputrelationTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ],
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        await VisitorsRecord.createDoc(widget.patientref!)
                          ...
                          relation: _model.inputrelationTextController.text,
