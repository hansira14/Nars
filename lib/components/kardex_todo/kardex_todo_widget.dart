...
import 'kardex_todo_model.dart';
export 'kardex_todo_model.dart';

class KardexTodoWidget extends StatefulWidget {
  const KardexTodoWidget({
    super.key,
  ...
  @override
  State<KardexTodoWidget> createState() => _KardexTodoWidgetState();
}

class _KardexTodoWidgetState extends State<KardexTodoWidget> {
  late KardexTodoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KardexTodoModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.patient?.carelevel == 1) {
        ...
        setState(() {});
      } else if (widget.patient?.kardexcount == 0) {
        _model.carelevel = Color(0xFFD8D6D6);
        setState(() {});
      }
    });
                  ...
                  child: Row(
                    ...
                    children: [
                              ...
                              if (widget.patient?.hasDoctor() ?? true)
                                StreamBuilder<UsersRecord>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final doctorUsersRecord = snapshot.data!;
                                    return Text(
                                      valueOrDefault<String>(
                      ...
                      Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          if (widget.patient?.kardexcount == 0)
                            Icon(
                              Icons.check_circle,
                              color: _model.carelevel,
                              size: 50.0,
