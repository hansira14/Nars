...
import 'nursenotes_model.dart';
export 'nursenotes_model.dart';
...
class NursenotesWidget extends StatefulWidget {
  ...
  final ProgressNotesRecord? notes;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      dateTimeFormat('d/M h:mm a', widget.notes!.date!),
          ...
          Builder(
            builder: (context) {
              final note = widget.notes?.notes?.toList() ?? [];
