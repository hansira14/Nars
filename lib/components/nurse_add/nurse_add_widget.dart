...
import 'nurse_add_model.dart';
export 'nurse_add_model.dart';

class NurseAddWidget extends StatefulWidget {
  const NurseAddWidget({
    super.key,
  ...
  @override
  State<NurseAddWidget> createState() => _NurseAddWidgetState();
}

class _NurseAddWidgetState extends State<NurseAddWidget> {
  late NurseAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NurseAddModel());
