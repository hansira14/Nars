...
import 'acc_login_model.dart';
export 'acc_login_model.dart';

class AccLoginWidget extends StatefulWidget {
  const AccLoginWidget({super.key});

  @override
  State<AccLoginWidget> createState() => _AccLoginWidgetState();
}

class _AccLoginWidgetState extends State<AccLoginWidget>
    with TickerProviderStateMixin {
  late AccLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccLoginModel());
